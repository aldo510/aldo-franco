...
ActiveRecord::Schema[7.2].define(version: 2026_04_29_132000) do
  ...
  create_table "active_storage_attachments", force: :cascade do |t|
    ...
    t.index ["record_type", "record_id", "name", "position"], name: "index_active_storage_attachments_on_record_name_position"
  end
